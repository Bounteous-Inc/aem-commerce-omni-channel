...
%><%@ page contentType="text/html; charset=utf-8" %><%
    String productUgcPath = (String) request.getAttribute("cq.commerce.productTrackingPath");
    productUgcPath = trimHashAndExtension(productUgcPath);
...
<div class="product-social">
    <div>
        <cq:include path="<%= productUgcPath + "/jcr:content/rating"%>" resourceType="social/tally/components/hbs/rating"/>
    </div>
