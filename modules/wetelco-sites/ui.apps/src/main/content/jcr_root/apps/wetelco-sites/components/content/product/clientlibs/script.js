...
jQuery(function ($) {
    ...
    var allVariants = $("article.product, article.product_reference");
    ...
    allVariants.each(function() {
        ...
        function initVariantSwitch() {
            ...
            variantSwitch.find("li").each(function () {
                ...
                li.click(function () {
                    var oldQty   = thisForm.find(".product-quantity").find("input");
                    ...
                    newForm.find(".product-quantity input").val(oldQty.val());
                    if (isMobile) {
                    ...
                    product.children("article").addClass("isHidden");
