;(function (angular, contentUpdate, undefined) {
    ...
    angular.module( 'cqAppNavigation', ['ionic', 'btford.phonegap.ready'] )
        ...
        .controller( 'AppNavigationController',  ['$scope', '$http', '$window', '$location', '$timeout', 'phonegapReady', '$rootElement', '$ionicSideMenuDelegate', '$ionicTabsDelegate',
            function( $scope, $http, $window, $location, $timeout, phonegapReady, $rootElement, $ionicSideMenuDelegate, $ionicTabsDelegate) {
                ...
                $http.jsonp('http://api.wefinancedemo.com/telco?callback=JSON_CALLBACK').success(function (data) {
